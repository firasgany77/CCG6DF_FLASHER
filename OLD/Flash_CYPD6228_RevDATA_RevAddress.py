...
# Executing command: sudo i2ctransfer -y 2 w68@0x40 0x00 0x0C 0x40 0xD1 0x00 0x82 0x51 0x8A 0x49 0x38 0x59 0x8A 0x4D 0x37 0x49 0x38
...
def flash_row(bus, address, row_address, data):
    ...
    write_register(bus, address, 0x000C, [row_low_byte, row_high_byte] + reversed_data)
