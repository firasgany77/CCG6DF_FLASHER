...
# Executing command: sudo i2ctransfer -y 2 w68@0x40 0x00 0x0C 0x40 0xD1 0xF9 0xFE 0x07 0x28 0x04 0xD0 0x20 0x46 0xFB 0xF7 0xF4 0xFE
...
def erase_firmware(bus, address):
    ...
    try:
        ...
        raise Exception(f"Failed to erase previous firmware: {e}")
